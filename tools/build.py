...
""")
    ...
    for file in os.listdir(addonspath):
        if os.path.isfile(file):
            if check_for_obsolete_pbos(addonspath, file):
                removed += 1
                print("  Eliminando archivo obsoleto => " + file)
                os.remove(file)
    print("")
    ...
    for p in os.listdir(addonspath):
        ...
        if not check_for_changes(addonspath, p):
            skipped += 1
            print("  Saltandose {}.".format(p))
            continue

        print("# Compilando {} ...".format(p))
        ...
        try:
            ...
            failed += 1
            print("  Error al compilar {}.".format(p))
        else:
            made += 1
            print("  Hecho satisfactoriamente {}.".format(p))

    print("\n# Done.")
    print("  Hechos {}, Saltados {}, Eliminados {}, Fallados al compilar {}.".format(made, skipped, removed, failed))
